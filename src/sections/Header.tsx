      ...
      <div className="container">
        <div className="flex justify-between items-center h-24 md:h-28">
          ...
          <div className="flex gap-4 items-center">
            <button className="border-none outline-none  px-4 py-2 font-extrabold uppercase font-heading text-sm tracking-wide relative">
              ...
              <span className="leading-6 relative z-20">Get Started</span>
            </button>
